...
<AppearingLine class="text-subtitle-3 text-yellow-200 solid-text-shadow" text="Interface for First Person Shooter game"/>
<p>
	<AppearingLine as="span" text=" Designed to be " />
	<AppearingLine as="strong" class="text-yellow-200" text=" highly interactive " />
	<AppearingLine
		as="span"
